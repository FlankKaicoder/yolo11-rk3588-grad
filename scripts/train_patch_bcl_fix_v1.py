...
EXP_NAME = "patch_bcl_resnet18_fix_nosampler_ce_v1"
...
class BalancedContrastiveLoss(nn.Module):
    ...
    def forward(self, features, labels):
        ...
        # 关键修复点：
        # 这里不能直接 view(bsz * n_views, dim)
        # 正确展开应为 [view1全体, view2全体]
...
def main():
    ...
    for cls_idx, cnt in sorted(counter.items()):
        logger.info(f"class_idx={cls_idx}, count={cnt}")
